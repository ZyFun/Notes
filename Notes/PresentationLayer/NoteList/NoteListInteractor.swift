...
extension NoteListInteractor: NoteListBusinessLogic {
    ...
    private func createLearningNote() {
        let learningNote = NoteModel(
            ...
            6. Для изменения шрифта, просто нажмите на название шрифта и выберете нужный.
            7. Для форматирования выделенного текста, в появившемся всплывающем меню прокрутите в конец списка и выберите подходящее форматирование.
            """
        )
